...
X.each do |handle|
    list[handle[1..].length] += 1
end

list.each do |size, count|
    puts "Nombre de handles avec #{size} caractère(s) : #{count}"
end